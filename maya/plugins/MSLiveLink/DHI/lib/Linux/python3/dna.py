...
class StreamReader(Reader):
    ...
    @staticmethod
    def create(*args):
        return _py3dna.StreamReader_create(*args)

    @staticmethod
    def destroy(instance):
        return _py3dna.StreamReader_destroy(instance)
...
StreamReader.__new__ = __new_decorator(StreamReader_create, StreamReader.__new__)
...
class StreamWriter(Writer):
    ...
    def create(stream, memRes=None):
        return _py3dna.StreamWriter_create(stream, memRes)

    @staticmethod
    def destroy(instance):
        return _py3dna.StreamWriter_destroy(instance)
...
StreamWriter.__new__ = __new_decorator(StreamWriter_create, StreamWriter.__new__)
