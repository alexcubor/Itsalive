...
import tools_nk
reload(tools_nk)
from tools_nk.re_shuf_light import reShfLight
from tools_nk.CloseAllProperties import CloseAllProperties


toolbar = nuke.menu("Nodes")
menu = toolbar.addMenu("Itsalive", icon="bah_rnd.png")
menu.addCommand("reShfL", 'reShfLight()')
menu.addCommand("CloseAllProperties", 'CloseAllProperties()','ctrl+shift+a')